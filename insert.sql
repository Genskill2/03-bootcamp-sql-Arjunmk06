...
insert into books(title,pubisher) values ("The C Programming Language",1); 
insert into books(title,pubisher) values ("The Go Programming Language",1); 
insert into books(title,pubisher) values ("The UNIX Programming Language",1); 
insert into books(title,pubisher) values ("Cryptonomicon",2); 
insert into books(title,pubisher) values ("Deep Work",3); 
insert into books(title,pubisher) values ("Atomic Habits",4); 
insert into books(title,pubisher) values ("The City and The City",5); 
insert into books(title,pubisher) values ("The Great War For civilisation",6);
